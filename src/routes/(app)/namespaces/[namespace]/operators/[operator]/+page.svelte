...
<main>
	...
	{:else}
		...
		<TabGroup tabNames={['Overview', 'NATS', 'Accounts']}>
			<div slot="1">
				<TabCard>
					<OperatorOverview bind:loading operator={operator} />
				</TabCard>
			</div>
			<div slot="2">
				<div>
					{#if !loading && !operator.status.connected}
						<Banner bannerType="signup" dismissable={false}
							...
							<span class="inline-flex p-0.5 me-3 bg-gray-200 rounded-full dark:bg-red-900/50">
						...
						<Timeline order="vertical">
							...
							<TimelineItem title="Proxy Agent token">
								...
								<div class="my-4">
									...
									{:else}
										<Button on:click={generateProxyToken}>
